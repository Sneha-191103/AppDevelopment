...
import com.creativefusion.happytummy.repository.HotelRepository;
...
public class HotelServiceImpl implements HotelService {
	 ...
	 private final HotelRepository hotelRepository;
	    ...
	    public List<HotelResponse> getAllHotels() {
	        ...
	        return hotelList.stream()
	                .map(hotel -> {
	                    ...
	                    hotelResponse.setHotelImg(hotel.getHotelImg());
		...
		@Override
		public HotelResponse updateHotel(HotelRequest request, Long hid) {
			 Hotel hotel = hotelRepository.findByHid(hid);

		        if (hotel != null) {
		            hotel.setHotelName(request.getHotelName());
		            hotel.setHotelImg(request.getHotelImg());
		           ...
		           hotelRepository.save(hotel);
		            ...
		            throw new EntityNotFoundException("Hotel with mid " + hid + " not found");
		        }
		}
